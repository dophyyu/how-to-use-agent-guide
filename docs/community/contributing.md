...
WorkBuddy 的能力、界面和使用方式会持续变化。WorkBuddy Guide 希望由真实使用者共同维护：不仅纠正事实，也不断补充可复现的任务、失败经验和团队方法。
...
请先阅读[Case 投稿指南](/community/case-contributing)。PR 合并后，案例会自动显示在网站的案例集合页；经过进一步复现和编辑的经典任务，未来可能进入 WorkBuddy Guide 正文。
...
如果你想交流共创想法、提交案例，或者参与 WorkBuddy Guide 后续维护，可以扫描二维码联系我们。点击图片可查看大图。
